        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto items-center">
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-300 max-w-md mx-auto">
                Abdul crafts the stories and visuals that give brands a soul. With a background in
                both UI/UX design and brand strategy, he is obsessed with creating user journeys that
                are not just beautiful, but also deeply intuitive.
              </p>
            </div>
          </div>
        </div>
